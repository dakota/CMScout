...
To get CMScout3 to work do the following (assuming you already have cloned the git repository):
...
*create cmscout/config/database.php and insert the following (Changing where necessary):
	<?php
