	...
	public function eventFilePaths($dir = 'controllers') {
		...
		if (count($folders) > 1) {
			foreach ($folders as $pluginsFolder) {
				...
				if(file_exists(PLUGINS . $pluginsFolder . DS . $pluginsFolder . '_app_controller_events.php'))
				{
					$eventFilePaths[self::file2class($pluginsFolder . '_app_controller_events.php')] = PLUGINS . $pluginsFolder . DS . $pluginsFolder . '_app_controller_events.php';
				}
				
				if(file_exists(PLUGINS . $pluginsFolder . DS . $pluginsFolder . '_app_model_events.php'))
				{
					$eventFilePaths[self::file2class($pluginsFolder . '_app_model_events.php')] = PLUGINS . $pluginsFolder . DS . $pluginsFolder . '_app_model_events.php';
				}
			}
		}
